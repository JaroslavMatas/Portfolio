...
export const CardShotHover = forwardRef<HTMLDivElement, CardShotVideoProps>(({title}, ref) => (
  <div className="absolute right-0 bottom-[-1px] left-0 pointer-events-none">
    <div
      ref={ref}
      className="translate-y-[88px] opacity-0 w-full h-[87px] bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.06)_30%,rgba(0,0,0,0.45)_100%)] flex items-end px-[16px] pb-[15px] will-change-[transform,opacity] transform-gpu"
    >
